 ...
 */
public class PrintWriter150mm extends PrintWriter {

    public PrintWriter150mm() {
        super(PaperSize.PAPER_SIZE_150, 0);
    }
     ...
     */
    PrintWriter150mm(int textsize) {
        super(PaperSize.PAPER_SIZE_150, textsize);
    }
    ...
    public int getLineWidth(@IntRange(from = 0, to = 1) int textSize) {
        return PaperSize.LOGIC_SIZE_JOLIMARK_150 / (textSize + 1);
    }
    ...
    /**
     * 810 = 200 * 3(150最多一行三个) + 70 * 3（一行最多三个）
     * @return
     */
    @Override
