...
import static com.letion.app.mergeadapter.MergeAdapter.Config.StableIdMode.ISOLATED_STABLE_IDS;
import static com.letion.app.mergeadapter.MergeAdapter.Config.StableIdMode.NO_STABLE_IDS;
import static com.letion.app.mergeadapter.MergeAdapter.Config.StableIdMode.SHARED_STABLE_IDS;
...
class MergeAdapterController implements NestedAdapterWrapper.Callback {
     ...
     */
    private final IdentityHashMap<RecyclerView.ViewHolder, NestedAdapterWrapper>
